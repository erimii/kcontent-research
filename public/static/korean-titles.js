...
window.K_ACTOR_NAME_MAP = {
  ...
  // KNOWN_ACTORS_STATIC 동기화 — 사전엔 있는데 매핑 누락이던 배우들
  'shin min-ah': '신민아',
  'shin min ah': '신민아',
  'gong hyo-jin': '공효진',
  'gong hyo jin': '공효진',
  ...
  // K-pop 아이돌 (KNOWN_ACTORS_STATIC에 포함된 멤버들)
  'jun ho': '준호',
  'lee jun-ho': '이준호',
  'lee jun ho': '이준호',
  'taecyeon': '택연',
