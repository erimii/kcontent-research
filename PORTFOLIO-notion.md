...
![① 대시보드 상단](docs/screenshots/01-dashboard.png)
**① 대시보드 상단** — 사이드바 6개 메뉴 + 헤더(날짜·표본 수)

![② K-콘텐츠 트렌드 분석 (Reddit)](docs/screenshots/02-trends.png)
**② K-콘텐츠 트렌드 분석 (Reddit)** — 작품·배우·키워드 가로 막대 차트 + 한국어 인사이트 4개

![③ MDL Top Airing TOP 5](docs/screenshots/03-mdl.png)
**③ MDL Top Airing TOP 5** — 포스터·평점·평점 분포·댓글 감정·평가 분열 자동 탐지

![④ YouTube 파헤치기](docs/screenshots/04-youtube.png)
**④ YouTube 파헤치기** — 작품별 화제도 + 한국 원제 + 좋아요 TOP 댓글 한국어 번역

![⑤ Instagram Reels 분석](docs/screenshots/05-instagram.png)
**⑤ Instagram Reels 분석** — Reel 캡처 + 작품별 화제도 + Groq 3-라벨 반응 요약

![⑥ 도움말 (비전공자 가이드)](docs/screenshots/06-help.png)
**⑥ 도움말 (비전공자 가이드)** — 4-블록 구조: 무엇/어디서/어떻게/알아두면

![⑦ 스케줄 & 자동화](docs/screenshots/07-schedule.png)
**⑦ 스케줄 & 자동화** — 평일 09:40 자동 크롤 + 10:00 발송 / 금요일 수동 주간 크롤

![⑧ 명작 랭킹](docs/screenshots/08-ranking.png)
